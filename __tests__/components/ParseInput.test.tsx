...
describe('ParseInput Component', () => {
  ...
  it('renders input field and submit button', () => {
    ...
    expect(screen.getByPlaceholderText(/粘贴抖音链接/i)).toBeInTheDocument()
  ...
  it('validates Douyin URL format', () => {
    ...
    const input = screen.getByPlaceholderText(/粘贴抖音链接/i)
    ...
    // Should not call parseUrl with invalid URL
    expect(mockParseUrl).not.toHaveBeenCalled()
  })

  it('submits valid Douyin URL', async () => {
    render(<ParseInput />)
  ...
  it('clears input when clear button is clicked', () => {
    ...
    const input = screen.getByPlaceholderText(/粘贴抖音链接/i) as HTMLInputElement
